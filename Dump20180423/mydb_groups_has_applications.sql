...
CREATE TABLE `groups_has_applications` (
  ...
  CONSTRAINT `fk_Groups_has_Applications_Applications1` FOREIGN KEY (`Applications_AppName`) REFERENCES `applications` (`AppName`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Groups_has_Applications_Groups1` FOREIGN KEY (`Groups_GroupName`) REFERENCES `groups` (`GroupName`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `groups_has_applications` VALUES ('Accounting','QuickBooks'),('Human Resource','HR HelpDesk'),('Human Resource','QuickBooks'),('IT Department','MySQL Workshop'),('IT Department','Oracle VM VirtualBox'),('IT Department','Visual Studio 2017');
