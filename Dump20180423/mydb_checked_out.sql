...
CREATE TABLE `checked_out` (
  ...
  CONSTRAINT `fk_checked_out_credentials1` FOREIGN KEY (`credentials_UserName`, `credentials_Applications_AppName`) REFERENCES `credentials` (`UserName`, `Applications_AppName`) ON DELETE NO ACTION ON UPDATE NO ACTION
