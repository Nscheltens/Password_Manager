...
CREATE TABLE `users_has_groups` (
  ...
  CONSTRAINT `fk_Users_has_Groups_Groups1` FOREIGN KEY (`Groups_GroupName`) REFERENCES `groups` (`GroupName`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Users_has_Groups_Users1` FOREIGN KEY (`Users_idUsers`) REFERENCES `users` (`idUsers`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `users_has_groups` VALUES (1,'IT Department');
