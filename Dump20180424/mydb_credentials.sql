...
CREATE TABLE `credentials` (
  ...
  CONSTRAINT `fk_Credentials_Applications1` FOREIGN KEY (`Applications_AppName`) REFERENCES `applications` (`appname`)
...
INSERT INTO `credentials` VALUES (9,'Accounter','mm',1,'QuickBooks'),(7,'Boss','ImTHeB0$$',0,'QuickBooks'),(12,'DillPerterson','3ICfpoRTqAb3AQ4bzFVV3g==',0,'HR HelpDesk'),(8,'Helper','HelpingHands123',0,'HR HelpDesk'),(4,'itWorkSpace','TimeT0W0rk!',1,'Visual Studio 2017'),(6,'moneyman','ManageThatM0ney',0,'QuickBooks'),(5,'private','prIvAte2!',0,'Visual Studio 2017'),(2,'Prog','pr0gram1',0,'Oracle VM VirtualBox'),(1,'root','toor',0,'MySQL Workshop'),(3,'root','toor',0,'Oracle VM VirtualBox'),(93,'TomsHardware','ZTKZ+dbZTCBqkkkTCmVhBg==',1,'HR HelpDesk'),(83,'User1','Y09aPcT4Y+wCzeF8sDk7UQ==',0,'MySQL Workshop');
